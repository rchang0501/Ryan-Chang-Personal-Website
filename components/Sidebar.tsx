...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <button
        className="w-8/12 px-5 py-2 text-white bg-black rounded-full cursor-pointer bg-gradient-to-r from-green to-red-600 hover:scale-105 focus:outline-none"
      ...
      <button
        onClick={changeTheme}
        className="w-8/12 px-5 py-2 my-4 text-white bg-black rounded-full cursor-pointer bg-gradient-to-r from-green to-red-600 focus:outline-none hover:scale-105 "
      >
